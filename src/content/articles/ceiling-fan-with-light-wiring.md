---
title: "Ceiling Fan with Light Wiring: Single Switch, Dual Switch, and Remote"
description: "Complete wiring guide for ceiling fans with lights. Covers single-switch, dual-switch, and remote/smart control scenarios with wiring diagrams explained."
pubDate: 2026-04-19
...
**At the wall switch box:**
The single-pole switch interrupts the black wire. One switch terminal connects to the hot source; the other terminal connects to the switched hot wire running to the ceiling box.
...
**At the switch box (dual gang):**
Two single-pole switches, each in the same box:
...
**Canopy receiver kits:**
Most ceiling fans include a remote receiver option or sell one as an accessory. Third-party options like the Hunter Original remote kit or Hampton Bay UC7078T receiver work with many fan models.

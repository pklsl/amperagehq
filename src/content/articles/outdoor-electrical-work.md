---
title: "Outdoor Electrical Work: Wiring, Codes, and Best Practices"
...
1. Locate a nearby interior outlet on an exterior wall
2. Drill through the wall with a 1" spade or hole saw
3. Install a retrofit weatherproof box on the exterior
4. Run a short cable or conduit segment from the interior outlet to the new exterior box
5. The interior outlet feeding the exterior box must be on a GFCI-protected circuit, or use a GFCI outlet at the interior point
...
1. **Separate disconnect**: Required at the outbuilding (NEC 225.31–32) — can be the first breaker in a subpanel or a separate means of disconnect
2. **Grounding at the outbuilding**: A detached structure's subpanel is a separately derived system if it has its own ground rods. Ground rods (or another listed grounding electrode) must be installed at the outbuilding
3. **Feed method**: Underground feeder (UF-B cable or conductors in conduit) is typical; overhead service entrance cable is an option if spans are short and conductor clearances are met
4. **Minimum clearances for overhead wires**: Above driveways: 12 feet minimum; above pedestrian areas: 10 feet; above rooftops: 8 feet above roof level (or 3 feet if roof slope is ≥ 4:12)
...
- [GFCI and AFCI outlet installation](/articles/gfci-and-afci-outlet-installation) — every outdoor receptacle requires GFCI protection; this guide covers exactly how to install it correctly
- [Subpanel installation basics](/articles/subpanel-installation-basics) — running power to a detached garage or shed requires a subpanel with proper grounding; learn the grounding rules specific to separate structures
- [Wire gauge and ampacity guide](/articles/wire-gauge-and-ampacity-guide) — outdoor and underground wiring uses different insulation types; understand which conductors are rated for wet and direct-burial applications

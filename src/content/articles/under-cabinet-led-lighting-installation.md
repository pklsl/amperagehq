---
title: "Under Cabinet LED Lighting Installation Guide"
description: "Install hardwired or plug-in under cabinet LED lighting. Compare strip lights, puck lights, and bar lights with a step-by-step hardwired installation guide."
pubDate: 2026-04-19
...
1. **Select the channel:** Channels come in surface-mount, corner, and recessed varieties. For under cabinet, surface-mount or slim recessed channels work well.

2. **Cut to length:** Cut the aluminum channel to the exact cabinet width with a hacksaw or miter saw.

3. **Mount the channel:** Drill pilot holes and screw the channel to the underside of the cabinet.

4. **Install LED strip:** Remove the adhesive backing and press the strip into the channel's track.

5. **Snap in the diffuser:** The frosted plastic diffuser snaps into the channel, spreading the individual LED points into a smooth light band.

6. **Connect power:** The strip's tail connects to the driver's output via a quick-connect or solder joint.

---
title: "LED Recessed Light Retrofit Guide: Convert Can Lights to LED"
description: "How to convert existing can lights to LED using retrofit kits. Dimmer compatibility, wattage selection, color temperature, and step-by-step installation."
pubDate: 2026-04-19
...
**Pros:** Easiest installation — replace the old bulb and trim simultaneously; uses existing socket
**Cons:** Limited by socket wattage rating; may not seal the ceiling penetration; limited optical performance compared to wired kits
...
**Pros:** Better efficiency, better optical control, can create an airtight seal, longer life (no socket to fail)
**Cons:** Requires disconnecting the existing wiring — technically more involved than a bulb swap
...
**Pros:** Best performance, starts fresh with modern IC/AT-rated housing
**Cons:** More work, may require patching around the opening if sizes don't match
...
**Before (65W incandescent × 8 fixtures):** 520W per hour of operation
**After (9W LED × 8 fixtures):** 72W per hour
**Savings:** 448W per hour, or 4.48 kWh per 10 hours of use

...
1. Snap the new AFCI breaker onto the bus bar
2. Connect the circuit's black (hot) wire to the breaker's load terminal
3. Connect the circuit's white (neutral) wire to the breaker's neutral terminal (on the breaker itself — not the neutral bar)
4. Connect the breaker's white pigtail wire to the neutral bar
...
1. **Dual-function AFCI/GFCI breaker**: Provides both protections from the panel. Most straightforward option.
2. **AFCI breaker + GFCI outlet**: Install an AFCI breaker in the panel and a GFCI outlet at the first location on the circuit.
